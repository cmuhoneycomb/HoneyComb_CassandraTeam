...
public class SchoolDAO {
	...
	static SchoolDAO instance = null;

	public static SchoolDAO getInstance() {
		if (null == instance) {
			instance = new SchoolDAO("demo");
		}
		return instance;
	}

	public static SchoolDAO getNewInstance(String keyspaceName) {
		return new SchoolDAO(keyspaceName);
	}

	private final String keyspaceName;

	private SchoolDAO(String keyspaceName) {
	...
	private static School _constructResult(Row row) {
